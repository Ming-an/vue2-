<template>
    <div class="register-container">
        ...
        <div class="register">
            ...
            <div class="content">
                <label>验证码:</label>
                <input placeholder="请输入验证码" name="code" v-model="code" v-validate="{ required: true, regex: /^\d{6}$/ }"
            ...
            <div class="content">
                <label>登录密码:</label>
                <input placeholder="请输入登录密码" name="password" v-model="password"
                    v-validate="{ required: true, regex: /^[0-9A-z]{8,20}$/ }"
                    :class="{ invalid: errors.has('password') }">
                <span class="error-msg">{{ errors.first("password") }}</span>
            </div>
            <div class="content">
                <label>确认密码:</label>
                <input placeholder="请确认密码" name="password1" v-model="password1"
                    v-validate="{ required: true, is: password }" :class="{ invalid: errors.has('password1') }">
                <span class="error-msg">{{ errors.first("password1") }}</span>
            </div>
            <div class="controls">
                <input type="checkbox" name="agree" v-model="agree" v-validate="{ required: true, 'agree': true }"
